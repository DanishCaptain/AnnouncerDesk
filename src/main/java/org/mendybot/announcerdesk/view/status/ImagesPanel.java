...
import org.mendybot.announcerdesk.model.status.ImageModel;

public class ImagesPanel extends ArchiveResourcesPanel implements ArchiveResourceChangeListener
{
  private static final long serialVersionUID = 8102896429533522525L;
  private ImageModel model;

  public ImagesPanel(ImageModel model)
  {
    this.model = model;
  ...
  public void archiveResourcesUpdated()
  {
    ...
    List<ArchiveResource> list = model.getImages();
